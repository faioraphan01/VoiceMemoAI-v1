...
import { Trash2, Calendar, FileText, Zap } from 'lucide-react';
...
const NoteList = ({ refreshTrigger }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {notes.map((note) => (
        <div key={note.id} className="card bg-base-100 shadow-xl hover:shadow-2xl transition-shadow">
          <div className="card-body">
            ...
            {note.summary && (
              <div className="mb-4">
                ...
                <p className="text-base-content/90 bg-accent/10 p-3 rounded-lg">
                  {note.summary}
                </p>
              </div>
            )}
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-primary">Full Transcript</span>
              </div>
